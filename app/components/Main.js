...
// psuedocode
  // 1) on page load: a modal pops up with options to login or "guest slay" (first wire frame)
  // 2) click guest slay redirect to pre-written workout -fin. (3rd wire frame)
